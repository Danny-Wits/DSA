...
//        System.out.println(Arrays.equals(test3, sol3) ? "PASS" : "FAIL");
        ...
        System.out.println("Danishwer");
        answerD.qsort(test1);
        System.out.println(Arrays.equals(test1, sol1) ? "\u001B[42m"+"PASS" :  "\u001B[41m"+"FAIL");
        answerD.qsort(test2);
        System.out.println(Arrays.equals(test2, sol2) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        answerD.qsort(test3);
        System.out.println(Arrays.equals(test3, sol3) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        answerD.qsort(test4);
        System.out.println(Arrays.equals(test4, sol4) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        answerD.qsort(test5);
        System.out.println(Arrays.equals(test5, sol5) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        answerD.qsort(test6);
        System.out.println(Arrays.equals(test6, sol6) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        answerD.qsort(test7);
        System.out.println(Arrays.equals(test7, sol7) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
        var t=test8.clone();
        answerD.qsort(t);
        System.out.println(Arrays.equals(t, test8) ? "\u001B[42m"+"PASS" : "\u001B[41m"+"FAIL");
